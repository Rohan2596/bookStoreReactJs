...
class Login extends Component{
    ...
    onSubmit = (event) => {
        ...
        const validateForm = (errors) => {
            let valid = false;
            var uName = document.getElementById("outlined-basic").value;
            var uPass = document.getElementById("outlined-basic1").value;
    ...
    render(){
        ...
        return(
         ...
         <div className='detailsContactsLogin'> LOGIN
                                ...
                                <Button variant="contained" color="primary" style={{ marginBottom: "3%",marginLeft:"13%",marginTop:"5%"}} onClick={(event)=>{this.onSubmit(event)}} >
                                LOGIN
                                </Button>
                                </div>
                                </div>
